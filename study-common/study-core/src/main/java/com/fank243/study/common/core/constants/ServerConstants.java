 ...
 * 
 * @author FanWeiJie
 * @since 2022-10-03 01:23:28
 */
public class ServerConstants {

    public final static String SERVER_OAUTH2 = "study-oauth2";

    public final static String SERVER_SUPPORT = "study-support";

    public final static String SERVER_FILE = "study-file";

    public final static String SERVER_SYSTEM = "study-system";
