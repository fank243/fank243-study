...
import com.fank243.study.common.core.domain.model.ITreeNode;
...
public class TreeUtils {
     ...
     * @return 树形结构列表
     */
    public static <T extends ITreeNode<?>> List<T> generateTree(List<T> nodes) {
     ...
     * @return 叶子节点
     */
    public static <T extends ITreeNode<?>> List<T> getLeafList(T parent) {
     ...
     * @param <T> 实际节点类型
     */
    private static <T extends ITreeNode> void getLeafList(T parent, List<T> leafList) {
