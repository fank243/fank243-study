...
import com.github.fank243.study.${package.ModuleName}.domain.dto.${entity}DTO;
import com.github.fank243.study.${package.ModuleName}.domain.vo.${entity}VO;
import ${package.Service}.${table.serviceName};
import ${package.Entity}.${table.entityName}Entity;
import utils.com.github.fank243.study.common.core.ResultInfo;
import model.domain.com.github.fank243.study.common.core.PageBean;
import com.github.fank243.study.api.constants.ValidatorGroup;
...
<${entity}VO> getById(@PathVariable String id){
	...
	*/
	...
	public ResultInfo
	<PageBean
	<${entity}VO>> page(@RequestBody ${entity}DTO ${entity?uncap_first}){
		...
		*/
		@PostMapping("/add")
		public ResultInfo<?> add(@RequestBody @Validated({ValidatorGroup.Create.class}) ${entity}
		DTO ${entity?uncap_first}) throws BizException{
		...
		*/
		@PostMapping("/modify")
		public ResultInfo<?> modify(@RequestBody @Validated({ValidatorGroup.Modify.class}) ${entity}
		DTO ${entity?uncap_first}) throws BizException{
		boolean isOk = ${table.serviceName?uncap_first}.add(${entity?uncap_first});
