...
public class OauthUserController {
    ...
    public ResultInfo<?> userInfo(String accessToken, String openId) {
        ...
        OauthUserDTO oauthUserDTO = oauthUserService.findByUserId(Convert.toLong(accessTokenModel.loginId));
    ...
    public ResultInfo<?> modifyPassword(
        ...
        AccessTokenModel accessTokenModel = (AccessTokenModel)result.getPayload();
        oauthUserAccessTokenDTO.setUserId(Convert.toLong(accessTokenModel.loginId));
