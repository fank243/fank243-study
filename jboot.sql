...
CREATE TABLE `tb_3rd_pconline` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COMMENT='太平洋IP地址库';
...
CREATE TABLE `tb_log_system` (
  ...
  `gmt_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4 COMMENT='系统请求响应日志记录表';
...
CREATE TABLE `tb_sys_permission` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最近修改日期',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='权限表';
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='管理员表';

-- ----------------------------
-- Records of tb_sys_user
-- ----------------------------
BEGIN;
INSERT INTO `tb_sys_user` VALUES (1, 'admin', '张三', '13212345678', '', '6e77092b64d18e570a9da7afa60058b9', 'F21iGN0Z9VQ1gN7Vr4jO', 0, 0, NULL, '111.22.182.254', '2020-07-25 00:01:54', 0, NULL, '2020-03-24 19:48:52', '2020-07-25 00:54:22', '湖南省岳阳市 移通', '');
...
CREATE TABLE `tb_sys_user_event` (
  ...
  `gmt_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=397 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='管理员操作事件表';
...
INSERT INTO `tb_user` VALUES (3, 'test02', 'JBoot620266', '13212345670', '/images/photo.jpg', 1, 0, NULL, NULL, NULL, NULL, 0, NULL, '2020-03-29 00:28:09', '2020-07-18 13:49:08', 'f1463d3bd5f1a4b64c9b6d4cffbea6c3', 'CXGCnlaw0SjI72IaxLUI');
INSERT INTO `tb_user` VALUES (4, 'test03', 'JBoot336084', '13223242142', '/images/photo.jpg', 1, 0, NULL, NULL, NULL, NULL, 0, NULL, '2020-03-29 00:55:47', '2020-07-18 13:28:44', '3fc95675bba2b0df64bd7514d2b36fba', 'DA16XBzVlsGeC6IFZhER');
COMMIT;
