...
<div class="layui-fluid">
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            <table class="layui-table" lay-data="{url:'/admin/emailrecord/emailrecord', page:true, id:'layTable'}" lay-filter="layTable">
                <thead>
                <tr>
                    <th lay-data="{type:'checkbox', fixed: 'left'}"></th>
                    <th lay-data="{field:'id', width:80, sort: true}">序号</th>
                    <th lay-data="{field:'username'}">用户名</th>
                    <th lay-data="{field:'email'}">邮箱地址</th>
                    <th lay-data="{field:'ip'}">IP地址</th>
                    <th lay-data="{field:'ipAddr'}">IP归属地</th>
                    <th lay-data="{field:'title'}">邮件主题</th>
