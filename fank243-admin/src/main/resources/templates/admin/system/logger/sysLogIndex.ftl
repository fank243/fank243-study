    ...
    <div class="layui-card">
                ...
                <div class="layui-inline">
                    <div class="layui-input-inline">
                        <select name="logType" class="layui-select">
                            ...
                            <#list SysLogType.values() as logType>
        ...
        <div class="layui-card-body">
            <table class="layui-table"
                   lay-data="{width:'100%',url:'/admin/system/logger/sys/logList', page:true, id:'layTable'}"
                   lay-filter="layTable">
                <thead>
                <tr>
                    ...
                    <th lay-data="{field:'requestUri',width:280}">请求地址</th>
