            ...
            <div class="layui-form-item">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input class="layui-input" lay-verType="tips" lay-verify="required" name="name" value="${(permission.name)!}"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="radio" name="type" value="${PermissionType.BUTTON.name()?lower_case}"
                               title="${PermissionType.BUTTON.desc}" checked/>
                        <input type="radio" name="type" value="${PermissionType.MENU.name()?lower_case}"
                               title="${PermissionType.MENU.desc}"
                               <#if PermissionType.MENU.name() == (permission.type)!'button'>checked</#if>/>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <select name="spid" id="secondMenu" lay-filter="secondMenu">
                            <option value="0">请选择菜单</option>
                            <#if permissionList1??>
                                <#list permissionList1 as perm>
                                    <option value="${perm.id}" <#if (perm.id == sid1)!false>selected</#if>>${perm.name}</option>
                                </#list>
                            </#if>
                        </select>
                    </div>
                    <div class="layui-input-inline">
                        <select name="tpid" id="thirdMenu">
                            <option value="0">请选择菜单</option>
                            <#if permissionList2??>
                                <#list permissionList2 as perm>
                                    <option value="${perm.id}" <#if (perm.id == sid2)!false>selected</#if>>${perm.name}</option>
                                </#list>
                            </#if>
                        </select>
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input class="layui-input" name="permission" value="${(permission.permission)!}"
                               autocomplete="off" placeholder="请输入">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input class="layui-input" id="iconPicker" name="icon" value="${(permission.icon)!}"
                               autocomplete="off"/>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" class="layui-input" name="uri" value="${(permission.uri)!}"
                               autocomplete="off" placeholder="请输入访问URI"/>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <input type="radio" name="external" value="1" title="是"
                               <#if (permission.external)!false>checked</#if>>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">序号</label>
                    <div class="layui-input-block">
                        <input type="number" class="layui-input" lay-verify="required" lay-verType="tips" name="sort"
                               value="${(permission.sort)!0}" autocomplete="off" placeholder="请输入">
                    </div>
                </div>
            </div>
...
<script>
    layui.config({
        ...
        iconPicker.checkIcon("iconFonts","${(permission.icon)!''}","fontClass");
