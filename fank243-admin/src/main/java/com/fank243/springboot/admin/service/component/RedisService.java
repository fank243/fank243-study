package com.fank243.springboot.admin.service.component;
...
public class RedisService {
     ...
     *
     */
    public boolean setBit(String key, long l, boolean b) {
        try {
            redisTemplate.opsForValue().setBit(key, l, b);
            return true;
        } catch (Exception e) {
            e.printStackTrace();
            return false;
