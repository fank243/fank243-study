...
// *
// * value
// 资源名称，直接在sentinel控制台显示，默认为：类全限定名:方法名(参数类型全限定名,...)，示例：com.fank243.study.sentinel.controller.SentinelController:hello(java.lang.String)
// *
